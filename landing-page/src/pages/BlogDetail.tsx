...
export function BlogDetail() {
  ...
  if (!post) {
    return (
      <div className="pattern-grid-faded hero-mask" style={{ padding: '160px 0 120px', minHeight: '100vh', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center' }}>
