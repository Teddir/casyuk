          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(250px, 1fr))', gap: '24px', marginBottom: '100px' }}>
            ...
            <div className="neo-box" style={{ padding: '32px', backgroundColor: '#fff', color: '#000', display: 'flex', flexDirection: 'column' }}>
              ...
              <div style={{ fontSize: '2.5rem', fontWeight: 800, marginBottom: '24px', display: 'flex', alignItems: 'center', flexWrap: 'wrap' }}>
                <span style={{ textDecoration: 'line-through', color: 'var(--text-muted)', fontSize: '1.5rem', marginRight: '8px', fontWeight: 600 }}>$10</span>
                $5
                <span style={{ fontSize: '0.8rem', color: 'var(--accent-red)', fontWeight: 800, marginLeft: '12px', padding: '4px 8px', border: '2px solid var(--accent-red)', borderRadius: '4px', transform: 'rotate(-2deg)' }}>50% OFF</span>
              </div>
              <div style={{ display: 'flex', flexDirection: 'column', gap: '16px', marginBottom: '32px', flex: 1 }}>
              ...
              <NeoButton href="#" onClick={(e) => openModal(e, 'Professional')} style={{ width: '100%', backgroundColor: '#000', color: '#fff' }}>Get Access</NeoButton>
            </div>
            ...
            <div className="neo-box" style={{ padding: '32px', backgroundColor: 'var(--accent-green)', color: '#000', display: 'flex', flexDirection: 'column', transform: 'scale(1.05)', zIndex: 10 }}>
              ...
              <div style={{ fontSize: '2.5rem', fontWeight: 800, marginBottom: '24px', display: 'flex', alignItems: 'center', flexWrap: 'wrap' }}>
                <span style={{ textDecoration: 'line-through', color: 'rgba(0,0,0,0.4)', fontSize: '1.5rem', marginRight: '8px', fontWeight: 600 }}>$30</span>
                $15.90
                <span style={{ fontSize: '0.8rem', color: '#000', fontWeight: 800, marginLeft: '12px', padding: '4px 8px', border: '2px solid #000', borderRadius: '4px', transform: 'rotate(2deg)' }}>47% OFF</span>
              </div>
              <div style={{ display: 'flex', flexDirection: 'column', gap: '16px', marginBottom: '32px', flex: 1 }}>
            ...
            <div className="neo-box" style={{ padding: '32px', backgroundColor: 'var(--accent-blue)', color: '#000', display: 'flex', flexDirection: 'column' }}>
              ...
              <div style={{ fontSize: '2.5rem', fontWeight: 800, marginBottom: '24px', display: 'flex', alignItems: 'center', flexWrap: 'wrap' }}>
                ...
                $54.45
                <span style={{ fontSize: '0.8rem', color: '#000', backgroundColor: 'var(--accent-purple)', fontWeight: 800, marginLeft: '12px', padding: '4px 8px', border: '2px solid #000', borderRadius: '4px', transform: 'rotate(-1deg)' }}>SAVE $45</span>
              </div>
              <div style={{ display: 'flex', flexDirection: 'column', gap: '16px', marginBottom: '32px', flex: 1 }}>
